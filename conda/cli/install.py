...
def install(args, parser, command="install"):
    ...
    if isupdate and not (
        args.file or args.packages or context.update_modifier == UpdateModifier.UPDATE_ALL
    ):
...
"""
    ...
    if num_cp:
        if num_cp == len(args_packages):
            ...
            raise CondaValueError("cannot mix specifications with conda package" " filenames")
