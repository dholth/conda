...
class PipInstallerTest(unittest.TestCase):
    def test_straight_install(self):
        ...
        with mock.patch.object(pip.subprocess, "Popen") as mock_popen, mock.patch.object(
            pip, "pip_args"
            ...
            mock_popen.assert_called_with(
                ["pip", "install", "-r", "tmp-file"], cwd=root_dir, universal_newlines=True
            )
    ...
    def test_stops_on_exception(self):
        with mock.patch.object(pip.subprocess, "Popen") as popen:
            ...
            with mock.patch.object(pip, "pip_args") as pip_args:
                ...
                self.assertRaises(CondaValueError, pip.install, "/some/prefix", ["foo"], None)
