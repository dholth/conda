...
def test_parse_specification():
    test_reqs = {
        ...
        "requests[security] (>=1.1.0)": PySpec("requests", ["security"], ">=1.1.0", "", ""),
        "requests[security]>=1.5.0": PySpec("requests", ["security"], ">=1.5.0", "", ""),
        ...
        " name [ fred , bar ] ( >= 3 , < 2 ) ": PySpec("name", ["fred", "bar"], ">=3,<2", "", ""),
        ...
        ">=3,<2": PySpec("", [], ">=3,<2", "", ""),
        " ( >=3 , <2 ) ": PySpec("", [], ">=3,<2", "", ""),
        ">=2.7,!=3.0.*,!=3.1.*,!=3.2.*": PySpec("", [], ">=2.7,!=3.0.*,!=3.1.*,!=3.2.*", "", ""),
        "name>=1.0.0-beta.1,<2.0.0": PySpec("name", [], ">=1.0.0.beta.1,<2.0.0", "", ""),
