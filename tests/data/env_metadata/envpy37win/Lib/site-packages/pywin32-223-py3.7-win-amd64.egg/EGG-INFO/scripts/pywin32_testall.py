...
if hasattr(os, "popen3"):
    ...
    def run_test(script, cmdline_rest=""):
        ...
        popen = subprocess.Popen(
            cmd, shell=True, cwd=dirname, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
        )
...
def find_and_run(possible_locations, script, cmdline_rest=""):
    for maybe in possible_locations:
        ...
        raise RuntimeError(
            "Failed to locate the test script '%s' in one of %s" % (script, possible_locations)
        )
...
if __name__ == "__main__":
    # win32
    maybes = [
        os.path.join(this_dir, "win32", "test"),
    ...
    # win32com
    maybes = [
        os.path.join(this_dir, "com", "win32com", "test"),
    ...
    # adodbapi
    maybes = [
        os.path.join(this_dir, "adodbapi", "tests"),
